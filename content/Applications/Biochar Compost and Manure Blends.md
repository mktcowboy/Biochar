---
tags: [applications, compost, manure, blends, soil, hub]
aliases: [Biochar compost, Charged biochar, Co-composting, Compost cluster hub]
updated: 2026-09-16
---

# Biochar Compost and Manure Blends

**Cluster hub** for compost / manure / co-composting pathways. Why nearly every serious agronomic guidance document says **do not apply raw biochar alone** when yield is the goal: compost and manure supply labile C, nutrients, and microbes; biochar supplies structure, sorption, and durable C.
...
| Note | Role |
|---|---|
| **This note** | Hub — why blend, NRCS scenarios, field headlines, practice checklist |
| [[Co-composting Science]] | COMBI mechanisms, coating, nitrate capture, process GHG metas |
| [[Farm Co-composting Practice]] | Loadings, pile ops, facility examples, CPS 336 logistics |
| [[Compost Blend Safety]] | Pathogens, maturity, EC/salts, P-index, contaminant gates |
| [[Matrix Pathways for Credits]] | Soil end-use vs CPS 336 vs CDR (cross-link; no deep CSI) |
...
## Facility co-composting headlines
...
These process metrics ≠ soil N₂O claims ([[GHG Fluxes]]).

### Commercial blend products (named, sourced)

- Pacific Biochar — bulk compost–biochar blends: https://pacificbiochar.com/compost-biochar-blends-available-in-bulk-maybe-near-you
- Wakefield — Pro Garden Mix (biochar + compost); CarbonBoost option: https://wakefieldbiochar.com/biochar-for-landscapers/
- ABI Compost Guidelines 2026 draft (5–10% v/v): https://biochar.org/wp-content/uploads/2026/06/Biochar-Guidelines-Compost-2026-Draft-V1.pdf
