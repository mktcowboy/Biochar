...
Brief hub on **product quality standards** for biochar (European Biochar Certificate, World Biochar Certificate / related EBC framing, and IBI Biochar Standards). These are not carbon-credit methodologies; they define material thresholds and labeling that producers, buyers, and some registries reference.
...
- [[CSI Global Biochar C-Sink]] — CSI pathway often discussed alongside EBC/WBC certification culture
- [[Puro.earth Overview]] / Puro cluster — how a registry may expect characterization aligned with quality practice
- [[Key Sources]] — official EBC and IBI URLs under Product standards
