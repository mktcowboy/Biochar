...
aliases: [Pyrolysis, Biochar production]
---
...
Thermochemical decomposition of cellulose, hemicellulose, and lignin yields:

1. **Solid** — biochar
2. **Liquids** — bio-oil
3. **Gases** — CO₂, CO, H₂, light hydrocarbons

## Typical ranges

| Mode | Temperature / rate | Favors |
|---|---|---|
| Slow pyrolysis | ~300–700 °C, low heating rate, minutes–hours | Biochar yield |
| Fast / flash pyrolysis | Higher heating rates, shorter residence | Liquids |

## Controls on properties

- Feedstock (wood, herbaceous, manure, sludge, shells…)
- Peak temperature, residence time, heating rate
- Reactor design, ash content

## Carbon content

Commonly **~50–90% C** by mass for woody/low-ash chars; much lower for high-ash manure/sludge or gasification residues ([[Woolf et al. 2021|Woolf et al., 2021]] · [DOI](https://doi.org/10.1021/acs.est.1c02425)).

### Carbon fraction examples ([Woolf et al., 2021](https://doi.org/10.1021/acs.est.1c02425))

| Feedstock / process | Approx. FC |
|---|---|
| Wood pyrolysis (mean) | ≈ 0.76 |
| High-T wood | ≈ 0.81 |
| Manure pyrolysis | ≈ 0.39 |
| Sewage sludge pyrolysis | ≈ 0.37 |
