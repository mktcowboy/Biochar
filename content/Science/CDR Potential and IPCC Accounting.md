---
tags: [science, CDR, IPCC]
aliases: [CDR potential, IPCC biochar accounting]
---
...
| Temperature class | F_perm |
|---|---|
| Low (350–450 °C) | **0.65** |
| Medium (450–600 °C) | **0.80** |
| High (>600 °C / high-T gasification) | **0.89** |
...
[[Biochar Soil GHG Inventory Model|models soil GHG from biochar]] extends this with H/C_org and soil-temperature predictors. DOI: [10.1021/acs.est.1c02425](https://doi.org/10.1021/acs.est.1c02425).
...
Net climate benefit is **dominated by biochar C permanence vs baseline biomass fate**, modulated by methane avoidance (rice, landfill), energy co-products, transport, and kiln CH₄ if poorly engineered ([Roberts et al. 2010](https://doi.org/10.1021/es902266r) onward; Matuštík et al. 2020 review; [Lehmann 2021](https://doi.org/10.1038/s41561-021-00852-8)).

State of CDR (2026) and Weng & Cowie (2025) place biochar as **largest current novel CDR contributor** with gigaton-scale technical/sustainable potential but much lower near-term economic/IAM deployment.

## MRV accounting insight (science side)

MRV can focus on mass produced × C fraction × permanence factor at the kiln/gate, with application verification—cheaper than full soil flux monitoring (Lehmann 2021). Markets implement this differently—see [[MRV Stack]].
